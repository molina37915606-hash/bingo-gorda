# CHECKLIST — BINGO DE LA GORDA - Beta

## Pruebas críticas de esta Beta

- [ ] DEMO abre con chat disponible y sin error `innerHTML null`.
- [ ] En móvil, durante la partida el chat queda debajo del juego y no tapa el cartón.
- [ ] En PC grande, cartón + reclamos quedan completos y el chat queda a la derecha.
- [ ] En 75 bolas se ven B-I-N-G-O: B azul, I dorado, N violeta, G verde, O rojo/naranja.
- [ ] La bolilla de 75 usa el mismo color de su letra y muestra letra + número.
- [ ] El historial de 75 conserva esos mismos colores.
- [ ] El centro libre de 75 muestra una estrella.
- [ ] Manual: a los 5, 10 y 19 segundos no aparece ninguna pista visual.
- [ ] Manual: recién a los 20 segundos aparece ayuda amarilla si el número sigue sin marcar.
- [ ] Automarcado sigue marcando inmediatamente.
- [ ] El progreso muestra claramente `Bolilla X / 75` o `Bolilla X / 90`.
- [ ] Comunidad siempre abre en modo nocturno y no cambia la preferencia Día/Noche del Bingo.
