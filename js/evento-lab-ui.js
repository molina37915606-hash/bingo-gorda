...
function injectStyles(){
  ...
  .eventMarqueeControl{margin-top:7px}.eventMarqueeRow{display:grid;grid-template-columns:minmax(0,1fr) auto auto;gap:5px}.eventMarqueeRow input{min-width:0;width:100%;background:var(--p3);color:#fff;border:1px solid var(--line);border-radius:8px;padding:8px}.eventMarqueeRow button{white-space:nowrap}
  ...
  #preview .eventPvLogoBox{grid-area:logo;min-height:0;display:flex;align-items:center;justify-content:center;gap:8px;border:1px solid #ffffff18;border-radius:9px;background:#0c0810aa;overflow:hidden;padding:5px}
  #preview .pvLogo{position:static!important;left:auto!important;width:auto!important;height:82%!important;max-width:52%!important;object-fit:contain!important;background:transparent!important;filter:none!important}
  ...
  #preview .eventPvMarquee{grid-area:marquee;min-height:0;display:flex;align-items:center;justify-content:center;position:relative;border:1px solid #ffffff20;border-radius:9px;background:#120c18;overflow:hidden;padding:5px 42px 5px 8px}
  ...
  #preview .eventPvBallBox{grid-area:ball;min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr) auto;place-items:center;gap:2px;border:1px solid #ffffff18;border-radius:9px;background:#130b19aa;padding:5px}.eventPvBallLabel{font-size:clamp(6px,.62vw,9px);font-weight:950;color:#d9cedd;letter-spacing:.08em}
  #preview .pvBall{width:min(58%,190px)!important;aspect-ratio:1!important;font-size:clamp(34px,5vw,76px)!important;border-width:3px!important}.eventPvCount{font-size:clamp(6px,.62vw,9px);font-weight:850;color:#d6cad9}
  #preview .eventPvRecentBox{grid-area:recent;min-height:0;display:grid;grid-template-columns:repeat(5,1fr);gap:3px}.eventPvRecentBox i{display:grid;place-items:center;min-width:0;min-height:0;border-radius:5px;background:#701b68;border:1px solid #c467bb;font-style:normal;font-size:clamp(6px,.7vw,11px);font-weight:1000}.eventPvRecentBox i.empty{background:#211426;border-color:#ffffff16;color:#655b69}
  #preview .eventPvSponsor{grid-area:sponsors;min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr) auto;place-items:center;gap:3px;border:1px solid #ffffff18;border-radius:9px;background:#0b0710;overflow:hidden;padding:5px}.eventPvSponsorTitle{font-size:clamp(6px,.65vw,9px);font-weight:1000;color:#f2cc65;letter-spacing:.08em}.eventPvSponsor img{width:94%;height:100%;min-height:0;object-fit:contain;background:transparent}.eventPvSponsor span{max-width:94%;font-size:clamp(5px,.55vw,8px);font-weight:850;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
  #preview .pvBoard{grid-area:board!important;min-height:0;display:grid!important;gap:3px!important;align-content:stretch!important;padding:5px;border:1px solid #ffffff18;border-radius:9px;background:#0d0912}.pvNum{aspect-ratio:auto!important;border-radius:4px!important;font-size:clamp(6px,.68vw,11px)!important}.pvNum.hit{background:#8b217f!important;border-color:#e17bd5!important}.pvNum.lastHit{background:#f2c95d!important;color:#241600!important;border-color:#fff0a0!important}
  #preview .eventPvBottom{grid-area:bottom;min-height:0;display:grid;grid-template-columns:35% minmax(0,1fr);gap:1%}.eventPvPot{min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr) auto;place-items:center;border:1px solid #ffffff18;border-radius:9px;background:#100a16;padding:5px}.eventPvPot b{font-size:clamp(8px,.9vw,14px);color:#f4d477}.eventPvPotValue{font-size:clamp(15px,2.2vw,34px);font-weight:1000}.eventPvPot small{font-size:clamp(5px,.55vw,8px);color:#b9adbe}
  #preview .eventPvClosest{min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr);gap:3px}.eventPvClosestHead{display:flex;justify-content:space-between;gap:5px;font-size:clamp(5px,.55vw,8px);font-weight:950}.eventPvCards{min-height:0;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));grid-template-rows:repeat(2,minmax(0,1fr));gap:3px}.eventPvCard{min-width:0;min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr) auto;gap:1px;padding:3px;border:1px solid #ffffff18;border-radius:6px;background:#130c18;overflow:hidden}.eventPvCard b{font-size:clamp(4px,.43vw,7px);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.eventPvCard small{font-size:clamp(4px,.4vw,6px);color:#f1cc65;white-space:nowrap}.eventMiniGrid{min-height:0;display:grid;gap:1px}.eventMiniGrid.m75{grid-template-columns:repeat(5,1fr)}.eventMiniGrid.m90{grid-template-columns:repeat(9,1fr)}.eventMiniGrid i{display:grid;place-items:center;min-width:0;min-height:0;background:#f5f1f7;color:#211426;font-style:normal;font-size:clamp(3px,.31vw,5px);font-weight:950}.eventMiniGrid i.blank{background:#24162b;color:transparent}.eventMiniGrid i.hit{background:#f1ca55;color:#231500}
  #preview #pvSponsor{display:none!important}
  @media(max-width:900px){#sponsorGrid.eventUnlimited{grid-template-columns:1fr}.eventSponsorItem{grid-template-columns:86px minmax(0,1fr)}.eventSponsorItem .thumb{width:86px}}
  `;
...
function buildPreview(){
  ...
  preview.innerHTML=`
    ...
    <section class="eventPvBottom"><div class="eventPvPot"><b>POZO BINGO</b><div class="eventPvPotValue">BINGO</div><small id="pvPrizeNow">AHORA: LÍNEA</small></div><div class="eventPvClosest"><div class="eventPvClosestHead"><span>CARTONES CERCA DE GANAR</span><span id="pvPrizeTarget">LÍNEA</span></div><div id="pvCards" class="eventPvCards"></div></div></section>
...
function renderPreviewCards(drawn){const host=$('pvCards');if(!host)return;const {target,ranked,set}=closestAssigned(drawn);if($('pvPrizeTarget'))$('pvPrizeTarget').textContent=target;if($('pvPrizeNow'))$('pvPrizeNow').textContent=`AHORA: ${target}`;const items=ranked.map(item=>miniCard(item,set));while(items.length<6)items.push('<article class="eventPvCard" style="place-items:center;color:#6f6475">—</article>');host.innerHTML=items.join('')}
