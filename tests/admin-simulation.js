...
(async () => { try {
  ...
  const source = fs.readFileSync(path.join(__dirname, '..', 'server.js'), 'utf8'); assert(source.includes("DEMO_AI_NAME_POOL = ['Zoe', 'Mateo', 'Owen']")); assert(source.includes('shuffle(DEMO_AI_NAME_POOL).slice(0, aiCount)'));
