...
assert(communityHtml.includes('Crear sala pública')&&communityHtml.includes('id="publicRoomsList"'),'Comunidad debe ofrecer salas públicas y listarlas.');
assert(communityHtml.includes('id="publicRoomName"')&&communityHtml.includes('data-private-choice="start"')&&communityHtml.includes('id="publicRoomStartsAt"'),'Crear sala debe permitir nombre e inicio manual/programado.');
