...
for(const file of ['comunidad.html','player.html','admin.html','evento.html','evento-admin.html','evento-conductor.html','evento-elegir.html','tv.html','transmision.html']){
 const html=fs.readFileSync(path.join(root,file),'utf8');assert(html.includes('/js/i18n.js?v=final-internacional-'),file+' debe cargar i18n');
}
